...
import { HedgeTool } from './HedgeTool';
...
describe('HedgeTool', () => {
  ...
  it('renders kit controls, print strip, and dual-Y chart titles', () => {
    ...
    expect(screen.getByText('|Δ| trigger')).toBeTruthy();
    expect(screen.getByText('Realized vol')).toBeTruthy();
    expect(screen.getByText('Opt qty (− short)')).toBeTruthy();
